...
--
-- Host: localhost
-- Generation Time: Jul 31, 2023 at 01:21 PM
...
--
-- Database: `detection_of_deepfake_videos`
--
CREATE DATABASE IF NOT EXISTS `detection_of_deepfake_videos` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detection_of_deepfake_videos`;
...
('gkctrh9dd8nce74n4s0hutsmzodpu04a', 'eyJ1c2VyaWQiOjJ9:1qPOIy:b1HrrEMWx8d47p3r0PA-HRFBCJP6fSNX3kSdtWqcIJU', '2023-08-11 14:18:56.296676'),
...
('k23926lbimwu0jbzbxs1b15x8c0rlc3e', 'eyJ1c2VyaWQiOjF9:1qPN6r:6SGnQSxIlZ_0LZ57WYUup2pxw_seqyf1y0TOAuTsqRY', '2023-08-11 13:02:21.646059'),
...
--
-- Table structure for table `remote_user_deepfake_video_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_deepfake_video_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `video_id` varchar(300) NOT NULL,
  `title` varchar(300) NOT NULL,
  `channel_title` varchar(300) NOT NULL,
  `publish_time` varchar(300) NOT NULL,
  `tags` varchar(300) NOT NULL,
  `views` varchar(300) NOT NULL,
  `likes` varchar(300) NOT NULL,
  `dislikes` varchar(300) NOT NULL,
  `thumbnail_link` varchar(300) NOT NULL,
...
(13, 'Recurrent Neural Network-RNN', '53.92156862745098'),
(14, 'SVM', '52.94117647058824'),
(15, 'Gradient Boosting Classifier', '56.209150326797385');
...
(9, 'No Deepfake Video', '50.0'),
(10, 'Deepfake Video', '50.0');
