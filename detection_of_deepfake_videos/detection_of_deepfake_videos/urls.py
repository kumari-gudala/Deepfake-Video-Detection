"""Deepfake_Video_detection URL Configuration
...
from detection_of_deepfake_videos import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Video_Type/$', remoteuser.Predict_Video_Type, name="Predict_Video_Type"),
    ...
    url(r'^View_Prediction_Of_Video_Type_Ratio/$', serviceprovider.View_Prediction_Of_Video_Type_Ratio, name="View_Prediction_Of_Video_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Video_Type/$', serviceprovider.View_Prediction_Of_Video_Type, name="View_Prediction_Of_Video_Type"),
